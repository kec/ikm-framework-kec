...
import dev.ikm.orchestration.provider.knowledge.layout.component.ChronologyVersionsGridEmbeddedDetailsGrid;
...
public class ComponentVersionsGridEmbeddedDetailsGridWindowFactory implements KlFxWindowFactory {
    ...
    public KlFxWindow restore(KometPreferences preferences) {
        return KlFxWindow.restore(preferences);
    }
    ...
    public KlFxWindow create(KlPreferencesFactory preferencesFactory) {
        ...
        Label label = new Label("FxWindow containing Component Versions Grid");
        ...
        ChronologyVersionsGridEmbeddedDetailsGrid componentArea = new ChronologyVersionsGridEmbeddedDetailsGrid(preferencesFactory.get());
        viewContextMenuButtonArea.setCenter(componentArea);
